...
To install this just run `git clone https://github.com/AleexCaires/gulp-project-starter.git` followed by `cd Gulp-Project-Startup`, once you are at the root directory of you project just run `npm install` to install all dependencies.
